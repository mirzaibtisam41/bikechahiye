...
const Policy = () => {
  return (
    <div className='section-2 p-5 m-3 bg-white'>
           <div style={{fontSize:'18px', fontFamily:'sans-serif'}}className='row p-5 m-3 d-flex justify-content-center'>
            <h2 className="pb-5 bold ">Help & Support</h2>
    <span>
        We are very delighted that you have shown interest in REACT. Data
        protection is of a particularly high priority for the management of the
        REACT. The use of the Internet pages of REACT is possible without any
        indication of personal data; however, if a data subject wants to use
        special REACT services via our website, processing of personal data
        ...
        regulations applicable to Martel GmbH. By means of this data protection
        ...
        Controller, Martel GmbH has implemented numerous technical and
        organizational measures to ensure the most complete protection of
        personal data processed through this website.<br/> <span className="text-muted"> However, </span>Internet-based
        ...
        telephone.
        <span>
        If the processing of personal data is necessary
        and there is no statutory basis for such processing, we generally obtain
        consent from the data subject. The processing of personal data, such as
        the name, address, e-mail address, or telephone number of a data subject
        shall always be in line with the General Data Protection Regulation
        (GDPR), and in accordance with the country-specific data protection
        regulations applicable to Martel GmbH. 
        </span>
        </span>
      </div>
    </div>
